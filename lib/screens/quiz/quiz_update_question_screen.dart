  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(context.loc.update_quiz_question_screen_title),
      ),
      body: body(),
  ...
  Widget enterButton(BuildContext context) {
    return Column(
      children: [
        ...
        TextButton(
          child: Text(
            context.loc.quiz_screen_update_anwsers_button,
            style: const TextStyle(
              color: Colors.white,
              fontSize: 18,
            ),
                ...
                if (context.mounted) {
                  await loadingMessageTime(
                    title: response == EnumQuiz.success
                        ? context.loc.update_quiz_question_success_title
                        : context.loc.update_quiz_question_error_title,
                    subtitle: response == EnumQuiz.success
                        ? context.loc.update_quiz_question_success_content
